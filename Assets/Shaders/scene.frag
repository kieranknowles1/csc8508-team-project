...
void main(void)
{
	...
	albedo.rgb = pow(albedo.rgb, vec3(2.2)); //this transforms textures to linear space to then be gamma corrected
	...
	fragColor.rgb = pow(fragColor.rgb, vec3(1.0 / 2.2f));//GAMMA CORRECTION 
