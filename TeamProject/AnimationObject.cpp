...
AnimationObject::AnimationObject(GameObject* parent) {
    ...
    animations[SLIDING] = new MeshAnimation("/RacerGuy/AIOSlideNoRM.anm");
    ...
    animations[SPRINTING_LEFT] = new MeshAnimation("/RacerGuy/StrafeLeft.anm");
    animations[SPRINTING_RIGHT] = new MeshAnimation("/RacerGuy/StrafeRight.anm");
