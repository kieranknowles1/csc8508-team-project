...
void ServerObject::UpdateWorldState() {
...
void ServerObject::UpdateFromWorldState(float tickDT) {
...
std::vector<std::shared_ptr<Packet::Packet>> ServerObject::CreatePackets(int sequenceNum) {
